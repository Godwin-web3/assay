...
export const TOKENS: CatalogToken[] = [
  ...
  },
  {
    ...
    kind: "structured_note",
    claim: NOTE,
    notTheShare: "NVDAon is a note. It is not NVDA at the transfer agent.",
    docs: "https://docs.ondo.finance",
    group: "nvda",
  },
  {
  ...
  },
  {
    ...
    kind: "structured_note",
    claim: NOTE,
    notTheShare: "TSLAon is a note. It is not TSLA at the transfer agent.",
    docs: "https://docs.ondo.finance",
    group: "tsla",
  },
  {
  ...
  },
  {
    ...
    kind: "structured_note",
    claim: NOTE,
    notTheShare: "SPYon is a note. It is not SPY at the transfer agent.",
    docs: "https://docs.ondo.finance",
    group: "spy",
  },
];
